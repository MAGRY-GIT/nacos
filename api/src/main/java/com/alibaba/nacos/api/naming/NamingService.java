...
public interface NamingService {
    ...
    /**
     * Select one healthy instance of service using predefined load balance strategy.使用预定义的负载平衡策略选择一个健康的服务实例。
     *
     * @param serviceName name of service
